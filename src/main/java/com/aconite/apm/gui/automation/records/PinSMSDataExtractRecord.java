...
public class PinSMSDataExtractRecord
{
    private String id;
    ...
    {
        this.reqDateTime = millisecondsToOneDP(nullEmptyFix(reqDateTime));
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final PinSMSDataExtractRecord other = (PinSMSDataExtractRecord) obj;
